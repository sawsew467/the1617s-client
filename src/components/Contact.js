...
function Contact() {
  return (
    <>
      <footer className="w-full top-0 bg-green pt-4 lg:py-12" id="contact">
        <div className="container lg-auto mx-auto pr-7 pl-7 flex justify-between lg:flex-row flex-col">
          <div className="flex flex-col">
            ...
            <div className="mb-2 hover:text-primary transition-all">
              <i className="fa-solid fa-phone text-sm w-3"></i>
              <a className="footer__link text-sm lg:text-lg ml-2" href="tel:+84828828497">
                +84 828828497
              </a>
            </div>
            <div className="mb-2 hover:text-primary transition-all">
              ...
              <a
                className="footer__link text-sm lg:text-lg ml-2"
                href="mailto:thangtvb.dev@gmail.com"
              >
                thangtvb.dev@gmail.com
              </a>
            </div>
            <div className="mb-2 hover:text-primary transition-all w-80">
          ...
          <div className="lg:w-1/3 flex lg:mt-0 mt-4">
            <div className="w-1/2 flex flex-col lg:items-end">
              <p className="lg:mb-9 mb-2 text-sm lg:text-xl font-semibold lg:h-11">
                Về chúng tôi
              </p>
              <a
                className="text-sm lg:text-lg mb-2 hover:text-primary transition-all"
                href="#"
              >
                Giới thiệu
              </a>
