          ...
          <div className="flex flex-col gap-4">
            <div className="w-full bg-white rounded-lg drop-shadow-sm flex flex-col items-center">
              ...
              <div className="w-full flex justify-center">
                <img
                  className="w-2/3"
                  src={require("../assets/imgs/chicken/gà viên.png")}
                ></img>
              </div>
              <h4 className="text-2xl font-semibold">Gà viên chiên giòn</h4>
              <p className="opacity-50">8 Viên</p>
            ...
            <div className="w-full bg-white rounded-lg drop-shadow-sm flex flex-col items-center">
              ...
              <div className="w-full flex justify-center">
                <img
                  className="w-2/3"
                  src={require("../assets/imgs/chicken/gà vòng.png")}
                ></img>
              </div>
              <h4 className="text-2xl font-semibold">Gà vòng chiên giòn</h4>
              <p className="opacity-50">8 Viên</p>
              <div className="w-1/3 flex justify-center items-center">
                <div className="flex items-center text-[#588157] gap-1 font-medium">
                  <p className="text-lg">20K VNĐ</p>
